    ...
    "cat1": {
        ...
        "subcategories": [
            ...
            },
           {
                ...
                "लाभ घेणारा प्रवर्ग": "विमुक्त जाती, भटक्या जमाती व विशेष मागास प्रवर्ग",
                "items": [
                    # Flattened Prematric Scholarship schemes (removed subitems)
                    {
                        "name": "इ. ८वी ते १०वी मध्ये शिकणाऱ्या विजाभज व विमाप्र मुलींना सावित्रीबाई फुले शिष्यवृत्ती (मॅट्रिकपूर्व)",
                        "details": (
                    ...
                    {
                        "name": "इ. ८वी ते १०वी मध्ये शिकणाऱ्या इतर मागास मुलींना सावित्रीबाई फुले शिष्यवृत्ती (मॅट्रिकपूर्व)",
                        "details": (
                    ...
                    {
                        "name": "माध्यमिक शाळेत शिकत असलेल्या विजाभज/विमाप्र विद्यार्थ्यांना गुणवत्ता शिष्यवृत्ती (मॅट्रिकपूर्व)",
                        "details": (
                    ...
                    {
                        "name": "इयत्ता ५वी ते ७वी मध्ये शिकणाऱ्या इतर मागास विद्यार्थिनींना सावित्रीबाई फुले शिष्यवृत्ती (मॅट्रिकपूर्व)",
                        "details": (
                    ...
                    {
                        "name": "सैनिकी शाळेत शिकणाऱ्या विद्यार्थ्यांना शिष्यवृत्ती (मॅट्रिकपूर्व)",
                        "details": (
                    ...
                    {
                        "name": "माध्यमिक शाळेत शिकत असलेल्या मागासवर्गीय विद्यार्थ्यांना शिष्यवृत्ती (फक्त मुंबईकरिता) (मॅट्रिकपूर्व)",
                        "details": (
                    ...
                    {
                        "name": "इयत्ता १ली ते १०वी मध्ये शिकत असणाऱ्या विमुक्त जाती व भटक्या जमाती (DNT) विद्यार्थ्यांना डॉ. आंबेडकर शिष्यवृत्ती (मॅट्रिकपूर्व)",
                        "details": (
...
async def button(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if len(data) == 1:  # Category selection (e.g., cat1)
        ...
        # Display items as a numbered text list instead of buttons
        ...
        await query.message.edit_text(
            f"{subcategory['name']}:\n\n{items_text}\n\nकृपया योजना क्रमांक टाईप करा (उदा., 1, 2, ...).",
            reply_markup=reply_markup
        )
        # Store the current category and subcategory in context for item selection
        context.user_data["category_id"] = category_id
        context.user_data["subcat_idx"] = subcat_idx

    elif len(data) == 3:  # Item selection (e.g., cat1:1:item:0)
...
def main():
    ...
    application.add_handler(MessageHandler(filters.TEXT & ~filters.COMMAND, handle_item_selection))
